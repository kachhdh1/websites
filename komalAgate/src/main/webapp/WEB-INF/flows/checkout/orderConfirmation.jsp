					...
					<div
						...
						<div class="row">
							...
							<div class="col-xs-6 col-sm-6 col-md-6 text-right">
								<p>Billing Date: <fmt:formatDate type="date" value="${now}"/>
							</div>
						</div>
                            ...
                            <table class="table table-hover">
                                ...
                                <c:forEach var="cartItem" items="${order.cart.cartItems}" >
                                    <tr>
                                        ...
                                        <td class="col-md-1" style="text-align: center">${cartItem.totalAmount}</td>
                                    </tr>
                                </c:forEach>
						...
						<button class="btn btn-default"
							name="_eventId_backToCollectBillingDetail">Back</button>
